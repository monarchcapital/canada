...
# --- Configuration ---
st.set_page_config(layout="wide", page_title="CORRA Futures PCA Analyzer")
...
st.title("CORRA Futures PCA Analyzer")

# --- Sidebar Inputs ---
st.sidebar.header("1. Data Uploads")
price_file = st.sidebar.file_uploader(
    "Upload Historical Price Data (e.g., 'CORRA rates.csv')", 
    type=['csv'], 
    key='price_upload'
)
