...
if not price_df_filtered.empty:
    ...
    if loadings_spread is not None:
        ...
        * **Volatility/Mispricing:** Expressed as **Rate %** ($1\% = 100 \text{{ BPS}}$).
        ...
        st.markdown(r"""
This section performs a **PCA-based shock analysis** on the canada futures curve.
...
This gives a **curve-consistent, PCA-based view** of how the canada strip must move  
